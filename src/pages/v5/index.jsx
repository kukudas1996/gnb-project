  ...
  return (
    <div style={{ display: 'flex', gap: 8, padding: '0 16px', marginBottom: 20 }}>
      ...
      <div onClick={() => nav('history')} style={{
        flex: 1, backgroundColor: phase === 'applying' ? 'var(--color-primary-050)' : 'var(--color-neutral-100)', borderRadius: 16,
        padding: '12px 20px', cursor: 'pointer',
      }}>
        {phase === 'applying' ? (
          <>
            <div style={{ ...T.label13('medium'), color: 'var(--color-primary-500)', marginBottom: 2 }}>투자내역</div>
            <div style={{ ...T.body15('semibold'), color: 'var(--color-primary-500)' }}>신청중 투자 1건</div>
          </>
        ) : (
...
function PushNotificationScreen({ title, message, onTap }) {
  return (
    <div className="v5-screen" onClick={onTap} style={{
      ...
      <div className="v5-scroll" style={{ height: '100dvh', overflowY: 'auto' }}>
        ...
        <div style={{ padding: '12px 16px 0' }}>
          ...
          <div style={{ display: 'flex', gap: 8, marginBottom: 24 }}>
            ...
            <div onClick={() => nav('history')} style={{
              flex: 1, padding: 16,
              backgroundColor: phase === 'applying' ? 'var(--color-primary-050)' : 'var(--color-neutral-100)', borderRadius: 16,
              cursor: 'pointer',
            }}>
              {phase === 'applying' ? (
                <>
                  <div style={{ ...T.label13('medium'), color: 'var(--color-primary-500)', marginBottom: 2 }}>투자내역</div>
                  <div style={{ ...T.body17('semibold'), color: 'var(--color-primary-500)' }}>신청중 투자 1건</div>
                </>
              ) : (
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '100%' }}>
  ...
  return (
    <div className="v5-screen" style={S.screen}>
      <div className="v5-scroll" style={{ height: '100dvh', overflowY: 'auto' }}>
        ...
        {/* Progress stepper - both completed */}
        <div style={{ padding: '0 16px' }}>
...
function ShoppingScreen({ goTab }) {
  ...
  const ProductSection = ({ title }) => (
    <div style={{ padding: '28px 16px' }}>
      ...
      <div className="v5-hide-scrollbar" style={{ display: 'flex', gap: 8, overflowX: 'auto' }}>
