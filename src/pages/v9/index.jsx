...
export default function V7App() {
  ...
  switch (screen) {
    ...
    case 'asset':
      return <AssetScreen nav={navigate} goTab={goTab} phase={phase} phaseTransition={phaseTransitions[phase]} messageDismissed={messageDismissed} onDismissMessage={dismissMessage} />
    case 'my_account':
    ...
    <div className="v7-message-enter" style={{ padding: '0 16px' }}>
      <div style={{
        ...
        <div onClick={handleTap} style={{ display: 'flex', flex: 1, alignItems: 'center', gap: 8, minWidth: 0 }}>
          <img src="/a상품커버.png" alt="" style={{ width: 48, height: 48, objectFit: 'cover', flexShrink: 0, borderRadius: 12 }} />
...
function HomeScreen({ phase, nav, goTab, phaseTransition, messageDismissed, onDismissMessage, releaseAlertDone, onReleaseAlert }) {
  ...
  const investProducts = {
    ...
    settled: [
      { name: 'A 투자 상품', amount: '20,000원', shares: '1주', remaining: '8개월 남음', img: '/a상품커버.png', bgColor: '#dae7ff', clickable: true },
      { name: 'B 투자 상품', amount: '100,000원', shares: '5주', remaining: '2년 8개월 남음', img: '/b상품커버.png', bgColor: '#e87477' },
      { name: 'C 투자 상품', amount: '100,000원', shares: '5주', remaining: '2년 8개월 남음', img: '/c상품커버.png', bgColor: '#96ce68' },
    ],
    pre_settlement: [
    ...
    <div className="v7-screen" style={{
      ...
      <div style={{ position: 'fixed', bottom: 0, left: 0, right: 0, backgroundColor: 'var(--color-neutral-000)', borderTop: '1px solid var(--color-neutral-050)', zIndex: 20 }}>
        <div style={{ display: 'flex', alignItems: 'flex-start', padding: '4px 20px 0' }}>
          ...
          <TabBarItem icon="asset" label="자산" onClick={() => goTab('asset')} />
      ...
      <div style={{ padding: '0 20px', marginBottom: 20 }}>
        <div style={{
          ...
          <div style={{
            ...
            <img src="/a상품커버.png" alt="" style={{ width: 28, height: 28, objectFit: 'contain' }} />
          </div>
          <div style={{ flex: 1 }}>
...
// Asset Screen (투자 상세)
// ============================================================
function AssetScreen({ nav, goTab, phase, phaseTransition, messageDismissed, onDismissMessage }) {
  const phaseConfig = {
  ...
  return (
    <div className="v7-screen" style={{
      ...
      <div className="v7-scroll" style={{
        ...
        {/* AppBar */}
        <div style={{ position: 'sticky', top: 0, zIndex: 10, backgroundColor: 'var(--color-neutral-000)' }}>
          <div style={{ height: 60, padding: '0 16px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <span style={{ ...T.body17('semibold'), color: 'var(--color-neutral-800)' }}>자산</span>
          </div>
        </div>
      ...
      <div style={{ position: 'fixed', bottom: 0, left: 0, right: 0, backgroundColor: 'var(--color-neutral-000)', borderTop: '1px solid var(--color-neutral-050)', zIndex: 20 }}>
        <div style={{ display: 'flex', alignItems: 'flex-start', padding: '4px 20px 0' }}>
          ...
          <TabBarItem icon="asset" label="자산" selected />
          <TabBarItem icon="shopping" label="상점" onClick={() => goTab('shopping')} />
          <TabBarItem icon="feed" label="피드" onClick={() => goTab('feed')} />
          <TabBarItem icon="my" label="마이" onClick={() => goTab('my')} />
        </div>
...
function InvestHistoryScreen({ onBack, nav, phase }) {
  ...
  const applyingItems = phase === 'applying' ? [
    { name: 'A 투자 상품', desc: '20,000원 신청중', img: '/a상품커버.png', bgColor: '#dae7ff' },
  ] : []
        ...
        <div style={{ padding: '12px 16px 28px', display: 'flex', flexDirection: 'column', gap: 8 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            <div style={{ width: 36, height: 36, borderRadius: 12, backgroundColor: '#dae7ff', display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden', flexShrink: 0 }}>
              <img src="/a상품커버.png" alt="" style={{ width: 36, height: 27, objectFit: 'cover' }} />
            </div>
      ...
      <div className="v7-screen" style={{
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 8 }}>
          <div style={{ width: 100, height: 100, display: 'flex', alignItems: 'center', justifyContent: 'center', opacity: 0.3 }}>
            <img src="/a상품커버.png" alt="" style={{ width: 80, height: 60, objectFit: 'cover' }} />
          </div>
...
function MyInvestDetailScreen({ onBack, nav, phase, initialTab }) {
  ...
  const investHistoryItems = isPostSettlement ? [
    { date: '28년 12월 18일', items: [{ name: 'A 투자 상품', desc: '20,000원 정산 완료', img: '/a상품커버.png', bgColor: '#dae7ff' }] },
    { date: '26년 6월 12일', items: [{ name: 'A 투자 상품', desc: '20,000원 체결 완료', img: '/a상품커버.png', bgColor: '#dae7ff' }] },
  ] : [
    { date: '26년 6월 12일', items: [{ name: 'A 투자 상품', desc: '20,000원 체결 완료', img: '/a상품커버.png', bgColor: '#dae7ff' }] },
  ]
        ...
        <div style={{ background: 'linear-gradient(180deg, rgba(68,135,255,0.2) 0%, rgba(68,135,255,0) 100%)', paddingTop: 'env(safe-area-inset-top, 0px)' }}>
          ...
          <div style={{ padding: '0 24px', display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between' }}>
            ...
            <div style={{ width: 200, height: 200, display: 'flex', alignItems: 'flex-end', justifyContent: 'center', flexShrink: 0 }}>
              <img src="/a상품커버.png" alt="" style={{ width: 200, height: 200, objectFit: 'contain' }} />
            </div>
          </div>
        </div>
      ...
      <div className="v7-scroll" style={{ height: '100dvh', overflowY: 'auto', overflowX: 'hidden', paddingBottom: 'calc(77px + env(safe-area-inset-bottom, 0px))' }}>
        ...
        <div style={{ padding: '24px 16px', backgroundColor: '#fff' }}>
          ...
          <div className="v7-hide-scrollbar" style={{ display: 'flex', gap: 12, overflowX: 'auto', marginRight: -16 }}>
            {[
              { img: '/blogimage.png', title: '뱅카우는 어떤 기준으로 신규 공모 농가를 선정할까요?', desc: '까다로운 심사 기준과 선정 과정을 알려드릴게요', url: 'https://m.blog.naver.com/bancow-official/224330262729' },
