...
// Home Screens
// ============================================================
function HomeMyInvestSection({ amount, accountAmount = '100,000원', nav, children, phase }) {
...
// ============================================================
function InvestScreen({ nav, onBack, phase, goTab }) {
  const config = {
    ...
    <div className="v5-screen" style={{ ...S.screen, backgroundColor: 'var(--color-neutral-050)' }}>
      <div className="v5-scroll" style={{ ...S.scrollBody, backgroundColor: 'var(--color-neutral-050)' }}>
        ...
        <div style={{ ...S.appBar, backgroundColor: 'var(--color-neutral-050)' }}>
          <div style={{ ...S.appBarRow }}>
            <div style={{ ...T.headline24('bold'), color: 'var(--color-neutral-900)', flex: 1 }}>마이페이지</div>
          ...
          <div style={{
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <div style={{ fontSize: 14, fontWeight: 500, color: 'var(--color-neutral-600)', marginTop: 2, display: 'flex', alignItems: 'center', cursor: 'pointer' }}>
                내 정보
                {createElement(ChevronRight, { size: 20, color: 'var(--color-neutral-600)' })}
              </div>
            </div>
            <div style={{
              width: 100,
    ...
    <div style={{ padding: '28px 16px' }}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 10 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 4, cursor: 'pointer' }}>
          ...
          {createElement(ChevronRight, { size: 10, color: 'var(--color-neutral-700)' })}
        </div>
      </div>
    ...
    <div className="v5-screen" style={S.screen}>
      <div className="v5-scroll" style={S.scrollBody}>
        ...
        <div style={S.appBar}>
          <div style={S.safeTop} />
          <div style={S.appBarRow}>
            <div style={{ ...T.headline24('bold'), color: 'var(--color-neutral-900)', flex: 1 }}>쇼핑</div>
            <div style={{ width: 44, height: 44, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              {createElement(Bell, { size: 24, color: 'var(--color-neutral-800)', strokeWidth: 1.5 })}
            </div>
          </div>
...
const CONTENT_DATA = [
  { id: 1, title: '한우 투자, 이제 시작해도 늦지 않다', img: '/images/insight/content-1.png', url: 'https://blog.naver.com/bancow-official/223486068255' },
  { id: 2, title: '한우 투자, 이제 시작해도 늦지 않다', img: '/images/insight/content-2.png', url: 'https://blog.naver.com/bancow-official/223851285239' },
  { id: 3, title: '한우 투자로 얻는 수익과 리스크 분석', img: '/images/insight/content-3.png', url: 'https://blog.naver.com/bancow-official/224307947231' },
  { id: 4, title: '한우 투자로 얻는 수익과 리스크 분석', img: '/images/insight/content-4.png' },
  { id: 5, title: '초보자를 위한 한우 투자 가이드', img: '/images/insight/content-5.png' },
  { id: 6, title: '초보자를 위한 한우 투자 가이드', img: '/images/insight/content-6.png' },
]

const NEWS_DATA = [
  { id: 1, title: '한우 투자, 새로운 기회', desc: '최근 한우 시장의 변화와 투자 전략에 대한 분석이 필요합니다. 전문가들은 한우 투자에 대한 긍정적인 전망을 내놓고 있으며, 이는 농가의 수익성 향상으로 이어질 것으로 기대됩니다.', img: '/images/insight/news-1.png' },
  { id: 2, title: '한우 투자, 성공적인 사례', desc: '한우 투자에 성공한 사례를 통해 많은 투자자들이 긍정적인 결과를 얻고 있습니다. 이들은 지속적인 관리와 시장 분석을 통해 안정적인 수익을 창출하고 있습니다.', img: '/images/insight/news-2.png' },
  { id: 3, title: '한우 투자, 전문가의 조언', desc: '전문가들은 한우 투자를 고려하는 이들에게 시장 동향을 주의 깊게 살펴볼 것을 권장합니다. 또한, 장기적인 관점에서의 투자 계획이 중요하다고 강조하고 있습니다.', img: '/images/insight/news-3.png' },
]
