...
// Global Styles
// ============================================================
const globalStyleId = 'v8-global-styles'
...
export default function V7App() {
  ...
  const [historyDetailType, setHistoryDetailType] = useState(null)
  ...
  const navigate = useCallback((target, tab) => {
    ...
    if (target === 'history_detail' && tab) setHistoryDetailType(tab)
    else if (target !== 'history_detail') setHistoryDetailType(null)
  }, [screen])
  ...
  switch (screen) {
    ...
    case 'history_detail':
      return <InvestHistoryDetailScreen onBack={goBack} nav={navigate} phase={phase} detailType={historyDetailType} />
    ...
    case 'push_pre_settlement':
      return <PushNotificationScreen title="투자 정산" message="'A 투자 상품'이(가) 12월 28일에 정산 예정입니다." onTap={handlePushPreSettlementTap} />
    case 'push_post_settlement':
      return <PushNotificationScreen title="투자 정산" message="'A 투자 상품' 정산이 완료됐어요. 정산금 22,000원이 입금됐어요." onTap={handlePushPostSettlementTap} />
    default:
      return <HomeScreen phase={phase} nav={navigate} goTab={goTab} phaseTransition={phaseTransitions[phase]} messageDismissed={messageDismissed} onDismissMessage={dismissMessage} releaseAlertDone={releaseAlertDone} onReleaseAlert={() => setReleaseAlertDone(true)} />
  }
}
...
function DynamicMessage({ phase, dismissed, onDismiss, nav }) {
  ...
  const messages = {
    ...
    settled: { text: '1주 체결 완료됐어요', sub: 'A 투자 상품' },
    ...
    <div className="v7-message-enter" style={{ padding: '0 16px' }}>
      <div style={{
        ...
        <div onClick={handleTap} style={{ display: 'flex', flex: 1, alignItems: 'center', gap: 8, minWidth: 0 }}>
          <img src="/images/product-a.png" alt="" style={{ width: 48, height: 48, objectFit: 'cover', flexShrink: 0, borderRadius: 12 }} />
        ...
        <div onClick={(e) => { e.stopPropagation(); onDismiss() }} style={{ width: 44, height: 44, display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', flexShrink: 0 }}>
          <img src="/icons/close.svg" alt="닫기" style={{ width: 30, height: 30 }} />
        </div>
      </div>
    </div>
  )
...
function HomeScreen({ phase, nav, goTab, phaseTransition, messageDismissed, onDismissMessage, releaseAlertDone, onReleaseAlert }) {
  ...
  const investProducts = {
    pre: [
      { name: 'B 투자 상품', amount: '100,000원', shares: '5주', remaining: '2년 8개월 남음', img: '/images/product-b.png', bgColor: '#e87477' },
      { name: 'C 투자 상품', amount: '100,000원', shares: '5주', remaining: '2년 8개월 남음', img: '/images/product-c.png', bgColor: '#96ce68' },
    ],
    applying: [
      { name: 'B 투자 상품', amount: '100,000원', shares: '5주', remaining: '2년 8개월 남음', img: '/images/product-b.png', bgColor: '#e87477' },
      { name: 'C 투자 상품', amount: '100,000원', shares: '5주', remaining: '2년 8개월 남음', img: '/images/product-c.png', bgColor: '#96ce68' },
    ...
    settled: [
      { name: 'A 투자 상품', amount: '20,000원', shares: '1주', remaining: '8개월 남음', img: '/images/product-a.png', bgColor: '#dae7ff', clickable: true },
      { name: 'B 투자 상품', amount: '100,000원', shares: '5주', remaining: '2년 8개월 남음', img: '/images/product-b.png', bgColor: '#e87477' },
      { name: 'C 투자 상품', amount: '100,000원', shares: '5주', remaining: '2년 8개월 남음', img: '/images/product-c.png', bgColor: '#96ce68' },
    ],
    pre_settlement: [
      { name: 'A 투자 상품', amount: '20,000원', shares: '1주', remaining: '7일 남음', img: '/images/product-a.png', bgColor: '#dae7ff', clickable: true },
      { name: 'B 투자 상품', amount: '100,000원', shares: '5주', remaining: '2년 8개월 남음', img: '/images/product-b.png', bgColor: '#e87477' },
      { name: 'C 투자 상품', amount: '100,000원', shares: '5주', remaining: '2년 8개월 남음', img: '/images/product-c.png', bgColor: '#96ce68' },
    ],
    post_settlement: [
  ...
  const phaseConfig = {
    pre: { account: '100,000원', investAmount: '200,000원' },
    applying: { account: '40,000원', investAmount: '200,000원', showApplying: true },
    settled: { account: '80,000원', investAmount: '220,000원' },
    pre_settlement: { account: '80,000원', investAmount: '220,000원' },
    post_settlement: { account: '102,000원', investAmount: '200,000원' },
  }
              ...
              <div style={{ borderRadius: 20, overflow: 'hidden', backgroundColor: 'var(--color-neutral-050)', padding: '16px 20px 20px', display: 'flex', flexDirection: 'column', gap: 12 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                  <div style={{ width: 88, height: 88, borderRadius: 0, overflow: 'hidden', flexShrink: 0, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    <img src="/images/release-upcoming.png" alt="" style={{ width: 88, height: 88, objectFit: 'cover', opacity: 0.5 }} />
                  </div>
            ...
            <div onClick={() => nav('product_detail')} style={{ borderRadius: 16, overflow: 'hidden', padding: 8, background: 'linear-gradient(90deg, rgba(68,135,255,0.2), rgba(68,135,255,0.2)), linear-gradient(90deg, #fff, #fff)', display: 'flex', flexDirection: 'column', gap: 8, cursor: 'pointer' }}>
              <div style={{ padding: '8px 8px 0', display: 'flex', flexDirection: 'column', position: 'relative' }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', overflow: 'hidden' }}>
                  <img src="/images/product-a.png" alt="상품" style={{ width: 186, height: 140, objectFit: 'cover' }} />
                </div>
              ...
              <div style={{ backgroundColor: 'var(--color-neutral-000)', borderRadius: 12, padding: '16px 16px 20px', display: 'flex', flexDirection: 'column', gap: 12 }}>
                <span style={{ ...T.title20('bold'), color: 'var(--color-neutral-900)' }}>A 투자 상품</span>
                <div>
                ...
                <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
                  {[{ l: '1C 당 금액', v: '20,000원' }, { l: '예상 수익률', v: '10.0% ~ 15.0%' }].map(item => (
            ...
            <div style={{ padding: '12px 16px 0' }}>
              <div onClick={() => nav('history_detail')} style={{ backgroundColor: '#e8f0ff', borderRadius: 16, height: 56, padding: '0 20px 0 12px', display: 'flex', alignItems: 'center', cursor: 'pointer' }}>
                <div style={{ display: 'flex', alignItems: 'center', flex: 1, minWidth: 0 }}>
                  <img src="/images/product-a.png" alt="" style={{ width: 44, height: 33, objectFit: 'cover', flexShrink: 0 }} />
                ...
                <span style={{ ...T.body17('semibold'), color: 'var(--color-primary-500)', whiteSpace: 'nowrap', flexShrink: 0 }}>60,000원</span>
              </div>
            </div>
          )}
          {/* 계좌 잔액 */}
        ...
        <div style={{ position: 'fixed', inset: 0, zIndex: 9999 }}>
          ...
          <div className="v7-sheet-up" style={{ position: 'absolute', bottom: 0, left: 0, right: 0, backgroundColor: 'var(--color-neutral-000)', borderRadius: '20px 20px 0 0', padding: '0 16px', paddingBottom: 'calc(16px + env(safe-area-inset-bottom, 0px))', animation: 'v7-sheet-up 0.3s ease-out' }}>
            ...
            <div style={{ marginBottom: 24 }}>
              <img src="/images/release-sheet.png" alt="" style={{ width: '100%', borderRadius: 16 }} />
            </div>
      ...
      {showReleaseToast && (
        <div style={{ position: 'fixed', top: 'calc(env(safe-area-inset-top, 0px) + 60px)', left: 16, right: 16, zIndex: 10000, display: 'flex', justifyContent: 'center', animation: 'v7-toast-down 0.3s ease-out' }}>
          <div style={{ backgroundColor: 'var(--color-neutral-800)', borderRadius: 12, padding: '14px 20px', display: 'flex', alignItems: 'center', gap: 8 }}>
            <img src="/icons/check-green.svg" alt="" style={{ width: 20, height: 20 }} />
...
function AssetScreen({ onBack, nav, phase }) {
  const phaseConfig = {
    pre: { account: '100,000원', investAmount: '200,000원', showApplying: false, showItems: true },
    applying: { account: '40,000원', investAmount: '200,000원', showApplying: true, showItems: true },
    settled: { account: '80,000원', investAmount: '220,000원', showApplying: false, showItems: true },
    pre_settlement: { account: '80,000원', investAmount: '220,000원', showApplying: false, showItems: true },
    post_settlement: { account: '102,000원', investAmount: '200,000원', showApplying: false, showItems: true },
  }
  const config = phaseConfig[phase] || phaseConfig.pre
  ...
  const bottomMenuItems = [
    ...
    { icon: '/icons/graphic/flat-paper.svg', label: '중도해지 취소내역' },
  ]
      ...
      <div className="v7-scroll" style={{ height: '100dvh', overflowY: 'auto', overflowX: 'hidden' }}>
        ...
        <div style={{ padding: '16px 16px 20px' }}>
          <div style={{ display: 'flex', backgroundColor: 'var(--color-neutral-050)', borderRadius: 16 }}>
            {[
              { label: '내 계좌', icon: '/icons/graphic/money-bag.svg', action: () => nav('my_account') },
              { label: '투자내역', icon: '/icons/graphic/calendar.svg', action: () => nav('history') },
              { label: '정산내역', icon: '/icons/graphic/flat-paper.svg', action: () => nav('settlement_history') },
            ].flatMap((btn, idx, arr) => {
              const items = [
        ...
        {(() => {
          const assetProducts = (() => {
            const b = { name: 'B 투자 상품', amount: '100,000원', shares: '5주', remaining: '2년 8개월 남음', img: '/images/product-b.png', bgColor: '#e87477' }
            const c = { name: 'C 투자 상품', amount: '100,000원', shares: '5주', remaining: '2년 8개월 남음', img: '/images/product-c.png', bgColor: '#96ce68' }
            const a = { name: 'A 투자 상품', amount: '20,000원', shares: '1주', remaining: phase === 'pre_settlement' ? '7일 남음' : '8개월 남음', img: '/images/product-a.png', bgColor: '#dae7ff', clickable: true }
            ...
            <>
              ...
              <div style={{ paddingBottom: 24 }}>
                {assetProducts.map((item, idx) => (
                  <div key={idx} onClick={item.clickable ? () => nav('my_invest_detail') : undefined}
                    style={{ display: 'flex', alignItems: 'center', gap: 12, padding: 16, cursor: item.clickable ? 'pointer' : 'default' }}>
                    <div style={{ width: 48, height: 48, borderRadius: 16, backgroundColor: item.bgColor, display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden', flexShrink: 0 }}>
                      <img src={item.img} alt="" style={{ width: 40, height: 30, objectFit: 'cover' }} />
                    </div>
                    <div style={{ display: 'flex', flex: 1, minWidth: 0, gap: 12 }}>
...
function MyAccountScreen({ onBack, nav, phase }) {
  const balanceMap = {
    pre: '100,000', applying: '80,000', settled: '80,000',
    pre_settlement: '80,000', post_settlement: '102,000',
  }
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            <div style={{ width: 40, height: 40, borderRadius: 20, backgroundColor: '#03B24B', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
              <img src="/icons/finance/nh-bank.svg" alt="" style={{ width: 28, height: 28 }} />
            </div>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
                <span style={{ ...T.body15(), color: 'var(--color-neutral-600)' }}>NH농협은행</span>
                <img src="/icons/graphic/help.svg" alt="" style={{ width: 16, height: 16 }} />
              </div>
...
function AccountDetailScreen({ onBack, phase }) {
  ...
  const allTransactions = {
    pre: [
      { date: '5월 15일', name: '윤현우', time: '18:00', type: '입금', amount: '+ 300,000원', color: 'var(--color-primary-500)' },
      { date: '5월 15일', name: 'B 투자 상품 투자 신청', time: '12:00', type: '출금', amount: '- 100,000원', color: 'var(--color-neutral-800)' },
      { date: '5월 15일', name: 'C 투자 상품 투자 신청', time: '12:00', type: '출금', amount: '- 100,000원', color: 'var(--color-neutral-800)' },
    ],
    applying: [
      { date: '6월 1일', name: 'A 투자 상품 투자 신청', time: '12:31', type: '출금', amount: '- 20,000원', color: 'var(--color-neutral-800)' },
      { date: '5월 15일', name: '윤현우', time: '18:00', type: '입금', amount: '+ 300,000원', color: 'var(--color-primary-500)' },
      { date: '5월 15일', name: 'B 투자 상품 투자 신청', time: '12:00', type: '출금', amount: '- 100,000원', color: 'var(--color-neutral-800)' },
      { date: '5월 15일', name: 'C 투자 상품 투자 신청', time: '12:00', type: '출금', amount: '- 100,000원', color: 'var(--color-neutral-800)' },
    ],
...
function InvestHistoryScreen({ onBack, nav, phase }) {
  ...
  const applyingItems = phase === 'applying' ? [
    { name: 'A 투자 상품', desc: '20,000원 신청중', img: '/images/product-a.png', bgColor: '#dae7ff' },
  ] : []

  // 투자내역
  const historyByPhase = {
    pre: [
      { date: '26년 6월 12일', items: [{ name: 'B 투자 상품', desc: '100,000원 체결 완료', img: '/images/product-b.png', bgColor: '#e87477' }] },
      { date: '26년 6월 12일', items: [{ name: 'C 투자 상품', desc: '100,000원 체결 완료', img: '/images/product-c.png', bgColor: '#96ce68' }] },
    ],
    settled: [
      { date: '26년 6월 12일', items: [{ name: 'A 투자 상품', desc: '20,000원 체결 완료', clickable: true, detailType: 'settled', img: '/images/product-a.png', bgColor: '#dae7ff' }] },
      { date: '26년 6월 12일', items: [{ name: 'B 투자 상품', desc: '100,000원 체결 완료', img: '/images/product-b.png', bgColor: '#e87477' }] },
      { date: '26년 6월 12일', items: [{ name: 'C 투자 상품', desc: '100,000원 체결 완료', img: '/images/product-c.png', bgColor: '#96ce68' }] },
    ],
    post_settlement: [
      { date: '28년 12월 18일', items: [{ name: 'A 투자 상품', desc: '20,000원 정산 완료', clickable: true, detailType: 'post_settlement', img: '/images/product-a.png', bgColor: '#dae7ff' }] },
      { date: '26년 6월 12일', items: [{ name: 'A 투자 상품', desc: '20,000원 체결 완료', clickable: true, detailType: 'settled', img: '/images/product-a.png', bgColor: '#dae7ff' }] },
      { date: '26년 6월 12일', items: [{ name: 'B 투자 상품', desc: '100,000원 체결 완료', img: '/images/product-b.png', bgColor: '#e87477' }] },
      { date: '26년 6월 12일', items: [{ name: 'C 투자 상품', desc: '100,000원 체결 완료', img: '/images/product-c.png', bgColor: '#96ce68' }] },
    ],
  ...
  const data = historyByPhase[phase] || (phase === 'pre_settlement' ? historyByPhase.settled : historyByPhase.pre)
              ...
              {applyingItems.map((item, idx) => (
                <div key={idx} onClick={() => nav('history_detail')}
                  ...
                  <div style={{
                    ...
                    backgroundColor: item.bgColor || '#dae7ff',
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                    overflow: 'hidden', flexShrink: 0,
                  }}>
                    <img src={item.img || '/images/product-a.png'} alt="" style={{ width: 44, height: 33, objectFit: 'cover' }} />
                  </div>
                  <div style={{ flex: 1, minWidth: 0, display: 'flex', flexDirection: 'column', gap: 2 }}>
                    <span style={{ ...T.body17('semibold'), color: 'var(--color-neutral-800)' }}>{item.name}</span>
              ...
              {data.map((group, gIdx) => (
                <div key={gIdx} style={{ padding: '16px 0' }}>
                  ...
                  {group.items.map((item, iIdx) => (
                    <div key={iIdx} onClick={item.clickable ? () => nav('history_detail', item.detailType) : undefined}
...
// ============================================================
function InvestHistoryDetailScreen({ onBack, nav, phase, detailType }) {
  const isApplying = phase === 'applying'
  const isPostSettlement = detailType === 'post_settlement' || (!detailType && phase === 'post_settlement')
  ...
  const detailSections = isApplying ? [
  ...
  ] : isPostSettlement ? [
    {
      ...
      rows: [
        ...
        { label: '세후 수익률', value: '+10%', color: '#f76868' },
      ],
    ...
    },
    {
      ...
      rows: [
        ...
        { label: '내 수익금 (1주)', value: '+2,000원', color: '#f76868' },
      ],
    },
  ] : [
    {
        ...
        <div style={{ padding: '12px 16px 28px', display: 'flex', flexDirection: 'column', gap: 8 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            <div style={{ width: 36, height: 36, borderRadius: 12, backgroundColor: '#dae7ff', display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden', flexShrink: 0 }}>
              <img src="/images/product-a.png" alt="" style={{ width: 36, height: 27, objectFit: 'cover' }} />
            </div>
...
function SettlementHistoryScreen({ onBack, phase, nav }) {
  ...
  const settlementData = hasSettlement ? [
    { date: '28년 12월 1일', name: 'A 투자 상품', shares: '1주 정산', amount: '22,000원', diff: '2,000', rate: '10.00%', type: 'profit', img: '/images/product-a.png', bgColor: '#dae7ff' },
  ] : []
      ...
      <div className="v7-screen" style={{
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 8 }}>
          <div style={{ width: 100, height: 100, display: 'flex', alignItems: 'center', justifyContent: 'center', opacity: 0.3 }}>
            <img src="/images/product-a.png" alt="" style={{ width: 80, height: 60, objectFit: 'cover' }} />
          </div>
    ...
    <div className="v7-screen" style={{
      ...
      <div className="v7-scroll" style={{ height: '100dvh', overflowY: 'auto', overflowX: 'hidden' }}>
        ...
        <div style={{ padding: '20px 0', display: 'flex', flexDirection: 'column' }}>
          {[{ l: '총 투자금', v: '20,000원' }, { l: '수익 합계', v: '+2,000원', c: '#f76868' }, { l: '수익률', v: '+10.00%', c: '#f76868' }].map((row, idx) => (
...
function MyInvestDetailScreen({ onBack, nav, phase, initialTab }) {
  ...
  const investHistoryItems = isPostSettlement ? [
    { date: '28년 12월 18일', items: [{ name: 'A 투자 상품', desc: '20,000원 정산 완료', img: '/images/product-a.png', bgColor: '#dae7ff' }] },
    { date: '26년 6월 12일', items: [{ name: 'A 투자 상품', desc: '20,000원 체결 완료', img: '/images/product-a.png', bgColor: '#dae7ff' }] },
  ] : [
    { date: '26년 6월 12일', items: [{ name: 'A 투자 상품', desc: '20,000원 체결 완료', img: '/images/product-a.png', bgColor: '#dae7ff' }] },
  ]
        ...
        <div style={{ background: 'linear-gradient(180deg, rgba(68,135,255,0.2) 0%, rgba(68,135,255,0) 100%)', paddingTop: 'env(safe-area-inset-top, 0px)' }}>
          ...
          <div style={{ padding: '0 24px', display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between' }}>
            ...
            <div style={{ width: 200, height: 200, display: 'flex', alignItems: 'flex-end', justifyContent: 'center', flexShrink: 0 }}>
              <img src="/images/product-a.png" alt="" style={{ width: 200, height: 200, objectFit: 'contain' }} />
            </div>
          </div>
        </div>
                ...
                <div key={idx} style={{ border: '1px solid var(--color-neutral-100)', borderRadius: 16, padding: '16px 20px', boxShadow: '0 1px 3px rgba(0,0,0,0.04)' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                    <div style={{ width: 48, height: 48, borderRadius: 24, backgroundColor: 'var(--color-primary-050)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, overflow: 'hidden' }}>
                      <img src="/images/cow.png" alt="" style={{ width: 40, height: 40, objectFit: 'cover' }} />
                    </div>
                    <div style={{ flex: 1, minWidth: 0, display: 'flex', flexDirection: 'column', gap: 2 }}>
              ...
              <>
                ...
                <div style={{ padding: '12px 0 0' }}>
                  {[
                    ...
                    { l: '세후 수익금', v: '+2,000원', c: '#f76868' }, { l: '세후 수익률', v: '+10%', c: '#f76868' },
                  ].map((r, i) => (
                    <div key={i} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: 16 }}>
                      <span style={{ ...T.body17(), color: 'var(--color-neutral-700)' }}>{r.l}</span>
      ...
      <div className="v7-scroll" style={{ height: '100dvh', overflowY: 'auto', overflowX: 'hidden', paddingBottom: 'calc(77px + env(safe-area-inset-bottom, 0px))' }}>
        ...
        <div style={{ padding: '24px 16px', backgroundColor: '#fff' }}>
          ...
          <div className="v7-hide-scrollbar" style={{ display: 'flex', gap: 12, overflowX: 'auto', marginRight: -16 }}>
            {[
              { img: '/images/blog.png', title: '뱅카우는 어떤 기준으로 신규 공모 농가를 선정할까요?', desc: '까다로운 심사 기준과 선정 과정을 알려드릴게요', url: 'https://m.blog.naver.com/bancow-official/224330262729' },
        ...
        <div style={{ padding: '0 16px' }}>
          <div style={{ backgroundColor: 'var(--color-neutral-000)', border: '1px solid var(--color-neutral-100)', borderRadius: 16, overflow: 'hidden' }}>
            ...
            <div style={{ display: 'flex', padding: '16px 0', borderTop: '1px solid var(--color-neutral-100)' }}>
              {[
                { label: '내 계좌', icon: '/icons/graphic/money-bag.svg', target: 'my_account' },
